...
document.addEventListener("DOMContentLoaded", () => {
    ...
    document.getElementById("welcome").textContent = `Bienvenido, ${user_data[user_index].name
        }`;
    document.getElementById("balance").textContent = `Tu saldo es de: ${user_data[user_index].balance
        }`;
    ...
    document.addEventListener("submit", (e) => {
        ...
        if (e.submitter.value === "Salir") {
            globalThis.location.href = "/views/index.html";
        } else {
            ...
            if (!success) {
                ...
                globalThis.location.href = "/views/success.html";
            }
        }
    });
});
